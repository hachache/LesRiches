...
export const metadata: Metadata = {
  title: "Salaire ou épargne face à une fortune",
  description:
  ...
  return (
    <main className="mx-auto grid max-w-7xl gap-10 overflow-hidden px-4 py-10 sm:px-6 lg:px-8">
      <div className="mobile-safe-panel mx-auto mb-4 max-w-4xl text-center">
        ...
        <h1 className="display-type mt-4 text-balance text-5xl font-medium uppercase leading-[1] md:text-7xl">
          Salaire ou épargne face à une fortune.
        </h1>
